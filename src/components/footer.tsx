      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold font-montserrat mb-4">Elegance Beauty Salon</h3>
            <p className="text-gray-300 mb-4">
              Ahmedabad's premier women's beauty salon offering professional services in a luxurious, comfortable environment.
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300">
          <p>&copy; 2024 Elegance Beauty Salon. All rights reserved. | Ahmedabad's Premier Women's Beauty Destination</p>
        </div>
      </div>
    </footer>
  );
